...
export const getCandidates = async (req, res, next) => {
    try {
        const { page = '1', limit = '10', sort = '-createdAt', search, experienceMin, experienceMax, location, skills, currentCompany, salaryMin, salaryMax, noticePeriod, industry, pastIndustry, } = req.query;
        // Build filter query
        const query = {};
        // Experience range
